 ...
 ******************************************************************************/
uint8_t TxBuffer1[] = "\r\nCW32F003 UART HalfDuplex: USARTy -> USARTz\r\n";
uint8_t TxBuffer2[] = "\r\nCW32F003 UART HalfDuplex: USARTz -> USARTy\r\n";
...
void RCC_Configuration(void)
{
  ...
  //外设时钟使能
  RCC_AHBPeriphClk_Enable(USARTy_GPIO_CLK | USARTz_GPIO_CLK, ENABLE);
