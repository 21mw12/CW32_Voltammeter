...
int32_t main(void)
{
    ...
    I2C_InitStruct.I2C_AA = DISABLE;
		...
		while(1)
		{
			I2C_MasterWriteEepromData(WRITEADDRESS,u8Senddata,8);
			FirmwareDelay(3000);
			I2C_MasterWriteEepromData(WRITEADDRESS+8,u8Senddata2,8);
			FirmwareDelay(3000);
			I2C_MasterReadEepomData(WRITEADDRESS,u8Recdata,16);
			tempcnt++;
