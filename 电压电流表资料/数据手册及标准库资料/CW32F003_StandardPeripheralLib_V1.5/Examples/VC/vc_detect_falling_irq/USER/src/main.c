...
void VC_PortInit(void)
{
    ...
    //set PC01 as VC output
    PC01_AFx_VC1OUT();
    //set PA00 as VC1_CH7 P-INPUT
    PA00_ANALOG_ENABLE();
    //set PB01 as VC1_CH2 N-INPUT
    PB01_ANALOG_ENABLE();
}
...
int main(void)
{
    ...
    VC_PortInit();
    //VC通道初始化
    VC_InitStruct.VC_InputP = VC_InputP_Ch7;
    VC_InitStruct.VC_InputN = VC_InputN_Bgr1P2;	//VC_InputN_Ch2;	//
