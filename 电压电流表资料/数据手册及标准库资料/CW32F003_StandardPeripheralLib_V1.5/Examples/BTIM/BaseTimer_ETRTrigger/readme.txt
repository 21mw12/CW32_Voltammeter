...
硬件资源：
          ...
          5. PA05复用功能配置为BTIM_ETR，作为外部触发信号的输入端口
          6. PA07(LED1)设置为PUSH-PULL输出
          7. PA06(LED2)设置为PUSH-PULL输出
          8. PB05(KEY1)设置为中断输入口，中断类型下降沿


演示说明：
          BTIM1配置为触发启动模式，单次运行，以15625Hz时钟频率计数，设置ARR寄存器为15624；
          BTIM1计时满1s后溢出，溢出后，触发中断服务程序。中断服务程序中，PA07输出低电平，
          LED1灭。
          使用杜邦线将PB05脚与PA05脚连接，当按下KEY1时，将触发BTIM1启动计数，同时GPIOA的
          中断服务程序中，PA07输出高电平，LED1亮。
