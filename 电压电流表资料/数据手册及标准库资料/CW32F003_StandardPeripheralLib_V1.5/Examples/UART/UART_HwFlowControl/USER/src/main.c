...
#define  DEBUG_USART_CTS_GPIO_CLK       RCC_AHB_PERIPH_GPIOA
#define  DEBUG_USART_RTS_GPIO_CLK       RCC_AHB_PERIPH_GPIOA
...
#define  DEBUG_USART_CTS_GPIO_PIN       GPIO_PIN_6
#define  DEBUG_USART_RTS_GPIO_PORT      CW_GPIOA
#define  DEBUG_USART_RTS_GPIO_PIN       GPIO_PIN_7

//GPIO AF
#define  DEBUG_USART_AFTX               PB02_AFx_UART1TXD()
#define  DEBUG_USART_AFRX               PA00_AFx_UART1RXD()
#define  DEBUG_USART_AFCTS              PA06_AFx_UART1CTS()
#define  DEBUG_USART_AFRTS              PA07_AFx_UART1RTS()
 ...
 ******************************************************************************/
uint8_t TxBuffer[] = "\r\nCW32F003 UART HwFlowControl: UART <-> PC\r\n";
...
void RCC_Configuration(void)
{
  ...
  RCC_AHBPeriphClk_Enable(DEBUG_USART_TX_GPIO_CLK | DEBUG_USART_RX_GPIO_CLK |\
                          DEBUG_USART_CTS_GPIO_CLK | DEBUG_USART_RTS_GPIO_CLK, ENABLE);
