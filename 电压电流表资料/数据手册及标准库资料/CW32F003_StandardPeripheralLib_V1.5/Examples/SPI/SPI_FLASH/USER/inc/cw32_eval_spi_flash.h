...
//GPIO AF
#define FLASH_SPI_AF_SCK                  PA00_AFx_SPISCK()
#define FLASH_SPI_AF_MISO                 PA04_AFx_SPIMISO()
#define FLASH_SPI_AF_MOSI                 PA01_AFx_SPIMOSI()

//CS LOW or HIGH
#define FLASH_SPI_CS_LOW()                   PB02_SETLOW()
#define FLASH_SPI_CS_HIGH()                  PB02_SETHIGH()
