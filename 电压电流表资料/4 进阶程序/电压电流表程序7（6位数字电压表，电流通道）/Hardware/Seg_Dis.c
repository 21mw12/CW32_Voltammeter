...
void Seg_Dis(uint8_t Pos,uint8_t Num)
{
    ...
    case 2:
      ...
      break;
		case 3:
		  GPIO_WritePin(CW_GPIOA,GPIO_PIN_1,GPIO_Pin_RESET);  //PC02,COM3
      break;
    case 4:
		  GPIO_WritePin(CW_GPIOC,GPIO_PIN_0,GPIO_Pin_RESET);  //PC02,COM3
      break;
    case 5:
		  GPIO_WritePin(CW_GPIOC,GPIO_PIN_1,GPIO_Pin_RESET);  //PC02,COM3
      break;
		default:
      break;
	}
...
void Close_Com(void)
{
  ...
  GPIO_WritePin(CW_GPIOA,GPIO_PIN_1,GPIO_Pin_SET);    //PB07,COM1
	GPIO_WritePin(CW_GPIOC,GPIO_PIN_0,GPIO_Pin_SET);    //PC03,COM2
	GPIO_WritePin(CW_GPIOC,GPIO_PIN_1,GPIO_Pin_SET);    //PC02,COM3
}
